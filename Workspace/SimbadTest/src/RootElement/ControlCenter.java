...
import RootElement.Mission;import RootElement.MissionExecutor;import RootElement.Observer;import RootElement.Robot;
...
public class ControlCenter extends MissionExecutor {
	 ...
	 * 
	 */
	private static RootElement.ControlCenter instance = new ControlCenter(new Vector3d(0, 1, 0), "KingBoo");
	/**
	 * 
	 */
	 ...
	 * @return 
	 */
	public static RootElement.ControlCenter getInstance() {
	...
	public Robot addRobot(String robotType, Vector3d pos, String robotName, Color3f robotColor) {
		...
		MyRobotFactory robotFactory = MyRobotFactory.getInstance();
